function toggle(checkbox) {
    switch(checkbox){
        ...
        case 'postLinkClicks':
            ...
            let postLinkClicksClassToggled = postLinkClicks.classList.contains('hide');
        ...
        case 'trafficSources':
            ...
            let trafficSourcesClassToggled = trafficSources.classList.contains('hide');
            setLocalStorage(checkbox, trafficSourcesClassToggled);
            break;
        case 'subscribersTab':
            let subscribersTabXpath = "//span[text()='Subscribers']";
            let subscribersTab = document.evaluate(subscribersTabXpath, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
            subscribersTab.classList.toggle('hide');
            let subscribersTabClassToggled = subscribersTab.classList.contains('hide');
            setLocalStorage(checkbox, subscribersTabClassToggled);
            break;
        case 'statsTab':
            let statsTabXpath = "//span[text()='Stats']";
            let statsTab = document.evaluate(statsTabXpath, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
